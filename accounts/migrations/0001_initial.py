    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_interest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='accounts.loaninterestpercentage')),
            ],
        ),
        migrations.CreateModel(
            name='Debt',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('debt', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.debt')),
                ('fine_amount', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.loaninterestpercentage')),
            ],
        ),
        migrations.CreateModel(
            name='Notifications',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(2024, 4, 21, 21, 29, 59, 127791))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wage_percentage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.transactionfee')),
            ],
        ),
        migrations.CreateModel(
            name='Wallet',
